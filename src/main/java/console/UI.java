...
public class UI {
    ...
    public UI(Service service) {
        ...
        System.out.println("Trying functions...");
        this.service.saveStudent("123","SavedStudent",111);
        this.service.saveTema("123","TemaDescription",7,5);
        this.service.saveNota("123","123",7,5,"Veri gud");
